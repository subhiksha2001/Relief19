...
public class ReliefBot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relief_bot);
    ...
    public String GetText(String query) throws UnsupportedEncodingException {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Bearer 02a1b398d3da464a8105bf5aee430eaa");
...
//            jsonParam.put("name", "What are symptoms of corona?");
